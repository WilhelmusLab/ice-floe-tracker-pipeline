...
RUN julia --project=/opt/ice-floe-tracker-pipeline --compiled-modules=yes -e 'ENV["PYTHON"]=""; using Pkg; Pkg.instantiate(); Pkg.resolve(); Pkg.precompile(); Pkg.import("IFTPipeline")'
